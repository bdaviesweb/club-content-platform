...
remote_env="REPO_DIR='${REMOTE_DIR}' RUN_APPROVAL_PUBLISH_SMOKE='${RUN_APPROVAL_PUBLISH_SMOKE}' RUN_ADMIN_REVIEW_SMOKE='${RUN_ADMIN_REVIEW_SMOKE}' SMOKE_TIMEOUT_SECONDS='${SMOKE_TIMEOUT_SECONDS}' HEALTH_TIMEOUT_SECONDS='${HEALTH_TIMEOUT_SECONDS}' HEALTH_POLL_SECONDS='${HEALTH_POLL_SECONDS}'"
